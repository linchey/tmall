package com.lin.toymall.web.Util.validatecode;
...
public final class GraphicHelper {
    ...
    public static void main(String[] args) throws Exception {
       //GraphicHelper.create( 4 , true , 180 , 90 , new FileOutputStream( "D:/character.jpg" )  , 30);
      // GraphicHelper.create( 6 , false , 180 , 90 , new FileOutputStream( "D:/letter.jpg" )  , 30 );
